...
(function (AI) {
  ...
  var P = {
    ...
    /* 3D — 앞면과 옆면이 보이는 상자 */
    fx3dExtrude: {
      d: 'M2.5 5.5l5-3 6 2.5-5 3z',
      extra: '<path d="M2.5 5.5v5l5 3v-5z" opacity=".75"/><path d="M7.5 8.5v5l6-3.5v-5z" opacity=".45"/>'
    },
    fx3dRotate: {
      d: 'M8 2.5a5.5 5.5 0 1 0 0 11 5.5 5.5 0 0 0 0-11z',
      extra: '<ellipse cx="8" cy="8" rx="2.6" ry="5.5"/><path d="M2.5 8h11" opacity=".6"/>'
    },
    /* 왜곡 및 변형 — 원본(옅게) 위에 변형 결과를 겹쳐 보여 준다 */
    fxZigzag: { d: 'M1.5 8l2-4 2 8 2-8 2 8 2-8 2 4' },
    fxRoughen: { d: 'M1.5 9.5l1.3-2.6 1 1.6L5.4 5l1 3.2 1.2-2.2 1.1 2.6 1-3.4 1.2 2.4 1-1.4 1.6 2.8' },
    fxPucker: {
      d: 'M8 2c1.4 2.6 3.4 4.6 6 6-2.6 1.4-4.6 3.4-6 6-1.4-2.6-3.4-4.6-6-6 2.6-1.4 4.6-3.4 6-6z',
      extra: '<circle cx="8" cy="8" r="6" opacity=".3" stroke-dasharray="1.5 1.5"/>'
    },
    fxTwist: {
      d: 'M8 2.2c3.2 0 5.8 2.6 5.8 5.8M8 4.6c1.9 0 3.4 1.5 3.4 3.4M8 13.8c-3.2 0-5.8-2.6-5.8-5.8M8 11.4c-1.9 0-3.4-1.5-3.4-3.4'
    },
    fxTransformFx: {
      d: 'M2.5 8.5h5v5h-5z',
      extra: '<path d="M6 5h5v5H6z" opacity=".55"/><path d="M9.5 1.5h5v5h-5z" opacity=".3"/>'
    },
    fxFreeDistort: {
      d: 'M2 3.5l11-1.5 1.2 10.5L4 14z',
      extra: '<path d="M3.5 3.5h9v9h-9z" opacity=".3" stroke-dasharray="1.5 1.5"/>'
    },
    ...
    unlink: { d: 'M6.2 9.8 5 11a2.5 2.5 0 0 1-3.5-3.5l1.2-1.2M9.8 6.2 11 5a2.5 2.5 0 0 1 3.5 3.5l-1.2 1.2M2.5 2.5l11 11' },
    /* ---- 대지 이동 ---- */
